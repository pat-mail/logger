...
const int MAX_MESURES =  7*432;  //432/jour
...
void setup() {
  pinMode(BUTTON_PIN, INPUT_PULLUP);   // souvent INPUT_PULLUP sur ESP32

  Wire.begin();  // ESP32 I2C par défaut sur GPIO 21=SDA, 22=SCL, sinon Wire.begin(SDA, SCL);
  Serial.begin(9600);
